...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol: DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --priavte-key $(PRIVATE_KEY)--broadcast--verify--etherscan-api-key $(ETHERSCAN_API_KEY) 
	-vvvv
